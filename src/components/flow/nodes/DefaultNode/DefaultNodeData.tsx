...
export default function DefaultNodeDataDisplay({ data }: { data: NodeData }) {
  return (
    <div className="p-4 bg-white max-w-md mx-auto flex flex-col justify-between h-full">
      <div>
        <a href={data.url} target="_blank" rel="noopener noreferrer" className="text-blue-500 text-sm">
          {data.url}
        </a>
